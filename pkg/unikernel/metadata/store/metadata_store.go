...
// be thread-safe.
// TODO: Initialize the metadata store with a type, and replace
...
// TODO Add checkpoint. When checkpoint is enabled, it should cache data
...
func (m *metadata) update(u UpdateFunc) error {
	...
	// be affected.
	// TODO *Update* existing data on disk atomically,
...
func (m *metadata) delete() error {
	// TODO: Hold write lock, rename the data on the disk.
	return nil
}

// cleanup cleans up all temporary files left-over.
func (m *metadata) cleanup() error {
	// TODO: Hold write lock, Cleanup temporary files generated
...
func NewMetadataStore() MetadataStore {
	// TODO: Recover state from disk checkpoint.
	// TODO: Cleanup temporary files left over.
